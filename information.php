...
<body class="hold-transition login-page">
  <div class="container">
    ...
    <div class="login-box-body">
      <p class="login-box-msg text-center">Enter your Information</p>

      <form action="information-process.php" method="post">
      ...
      <a href="login.php" class="text-center">I am already a member</a><br>
